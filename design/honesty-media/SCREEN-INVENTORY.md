...
| HM-D08 | HM-06 | `/listing/:id` ("The street") + tether in `/listing/:id/walk` | part-built (HM-06): the section and map in `src/pages/ListingDetail.tsx`; no tether yet | [screens/HM-D08.md](screens/HM-D08.md) | D08, D09, D21 |
